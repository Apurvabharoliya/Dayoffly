...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 05, 2025 at 06:24 AM
...
(18, 40008, 'Maternity Leave', '2025-11-03 15:05:09', '2025-11-03', '2025-11-07', 'Illniss', NULL, 'declined', NULL),
(20, 40008, 'Maternity Leave', '2025-11-04 23:10:58', '2025-11-04', '2025-11-05', 'feefefe', NULL, 'declined', NULL),
(21, 40007, 'Maternity Leave', '2025-11-04 23:10:58', '2025-11-04', '2025-11-05', 'Seee all', NULL, 'declined', 'Test HR remarks from script');
...
(40014, 'Sick Leave', 0, 0, 0),
(40014, 'Vacation', 0, 0, 0),
(40014, 'Casual Leave', 0, 0, 0),
(40014, 'Maternity Leave', 0, 0, 0),
(40014, 'Paternity Leave', 0, 0, 0),
(40014, 'Sick Leave', 0, 0, 0),
(40014, 'Vacation', 0, 0, 0),
(40014, 'Casual Leave', 0, 0, 0),
(40015, 'Sick Leave', 0, 0, 0),
(40015, 'Vacation', 0, 0, 0),
(40015, 'Casual Leave', 0, 0, 0),
(40015, 'Maternity Leave', 0, 0, 0),
(40015, 'Paternity Leave', 0, 0, 0),
(40015, 'Sick Leave', 0, 0, 0),
(40015, 'Vacation', 0, 0, 0),
(40015, 'Casual Leave', 0, 0, 0);
...
(40013, 'Nensi', 'nensi@gmail.com', 'nens40013', 2, 4, '', '3377886644', 1, 30001, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Employee'),
(40014, 'Apurva', 'apurva@gmail.com', 'apur40014', 3, 4, 'Junior', '9999000089', 1, 30001, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Employee'),
(40015, 'Saumya', 'sa@ds.com', 'saum40015', 6, 4, 'Senior', '3434343483', 1, 30001, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Employee');

--
-- Triggers `users_master`
--
DELIMITER $$
CREATE TRIGGER `after_user_insert` AFTER INSERT ON `users_master` FOR EACH ROW BEGIN INSERT INTO leave_balance (user_id, leave_type, total_leaves, used_leaves, remaining_leaves) VALUES (NEW.user_id, 'Sick Leave', 0, 0, 0), (NEW.user_id, 'Vacation', 0, 0, 0), (NEW.user_id, 'Casual Leave', 0, 0, 0), (NEW.user_id, 'Maternity Leave', 0, 0, 0), (NEW.user_id, 'Paternity Leave', 0, 0, 0); END
$$
DELIMITER ;
